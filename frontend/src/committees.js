...
// Put your logos in 'frontend/src/assets/'
// For now, I'm using placeholders.

export const committees = [
  { id: 'technovanza', name: 'Technovanza', logo: 'src/assets/logos/techno_logo.png' },
  { id: 'sra', name: 'SRA (Society of Robotics)', logo: 'src/assets/logos/sra_logo.png' },
  { id: 'pratibimb', name: 'Pratibimb', logo: 'src/assets/logos/prati_logo.jpg' },
  { id: 'enthusia', name: 'Enthusia', logo: 'src/assets/logos/enthu_logo.png' },
